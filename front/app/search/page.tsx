...
function SearchContent() {
  ...
  const totalResults = projects.length + auctions.length
                        ...
                        {projects.length > 0 && (
                          <div>
                            <div className="flex items-center gap-2 mb-4">
                              ...
                              <h2 className="text-xl font-semibold">프로젝트 ({projects.length})</h2>
                            </div>
                        ...
                        {auctions.length > 0 && (
                          <div>
                            <div className="flex items-center gap-2 mb-4">
                              ...
                              <h2 className="text-xl font-semibold">경매 ({auctions.length})</h2>
                            </div>
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
